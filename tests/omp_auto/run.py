#!/usr/bin/env python3
"""Run OMP Auto contracts with the supported EdgeTX Lua fixture host."""
import argparse
import json
...
def instrument(source):
    ...
    exports = ('OMP_AUTO=OMP_AUTO,OPT=OPT,A=A,D=D,S=S,FC=FC,'
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='kse-omp-auto-') as temp:
        temp = Path(temp)

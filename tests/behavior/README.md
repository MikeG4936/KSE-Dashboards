...
- Transmitter battery native rounding/color boundaries at both physical widths, clamping, radio-range precedence over chemistry, one-second range refresh and clock rollback, independent warning voltage, malformed/missing/throwing settings fallback, and zero/noncurrent/NaN voltage.
